...
var marker = null, polyline = null, poly2 = null; markersToRemove = [];
...
function initializeMap() {
    ...
    // Create a map and center it on Victoria.
    var mapOptions = {
        zoom: 7,
        center: {
            lat: -37.372961,
...
function startSimulation(stops) {
     ...
     */
    var locations = JSON.parse(stops);
    ...
    var startCoords = {
			lat: locations.stops[0].stop_latitude,
